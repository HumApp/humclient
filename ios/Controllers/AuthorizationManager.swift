...
//        self.appleMusicManager = appleMusicManager
  ...
  @objc func requestMediaLibraryAuthorization(_ callback: RCTResponseSenderBlock) {
    ...
    func fetchDeveloperToken() -> String? {
      ...
      let developerAuthenticationToken: String? = "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Ikw4RE05UjJDWVYifQ.eyJpc3MiOiJMTlEyMllGOFVCIiwiaWF0IjoxNTAyNjU1Mzg3LCJleHAiOjE1MDI2OTg1ODd9.z1rFoGM3zwnXxAzuIqt-X9fDYUa7grqOUWFHHJZMCl8-_yApyr4K237pxddI_txskmksPeznOyFxRFDPNeh29A"
